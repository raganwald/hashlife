...
(function (root) {
  ...
  function foldl (list, binaryFn, optionalSeed) {
    return arguments.length === 2
           ? as_array(list).reduce(binaryFn)
           : as_array(list).reduce(binaryFn, optionalSeed);
  }
  
  function foldr (list, binaryFn, optionalSeed) {
    var arr = reverse(as_array(list));
    
    return arguments.length === 2
           ? arr.reduce(binaryFn)
           : arr.reduce(binaryFn, optionalSeed);
  }
  ...
  function compose2 (a, b) {
    return arguments.length === 1
           ? function (b) { return function () { return a.call(this, b.apply(this, arguments)); } }
           : function () { return a.call(this, b.apply(this, arguments)); }
  }
  
  function pipeline2 (a, b) {
    return arguments.length === 1
           ? function (b) { return function () { return b.call(this, a.apply(this, arguments)); } }
           : function () { return b.call(this, a.apply(this, arguments)); }
  }
  
  function compose () {
    return unvariadic(arguments[arguments.length - 1].length, foldl(arguments, compose2));
  }

  function pipeline () {
    return unvariadic(arguments[0].length, foldr(arguments, compose2));
  };
  ...
  // Snarfed from http://underscorejs.org
  // ------------------------------------
  
  extendClass = variadic(function (clazz, extensions) {
    
    return extensions.length > 1
           ? extend.apply(null, [clazz.prototype].concat([extensions]))
           : extend(clazz.prototype, extensions[0]);
  });
